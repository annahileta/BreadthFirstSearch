...
namespace BreadthFirstSearch
{
    class Program
    {
        ...
        static bool BFSSetup(int startPoint, int targetPoint)
        {
            ...
            return BFS(visited, startPoint, targetPoint);
        }

        static bool BFS(bool[] visited, int currentPoint, int targetPoint)
        {
            ...
            {
                var firstElement = pointsQueue.Dequeue();
                foreach (int point in pointAndItsAdjasent[firstElement])
                {
                    if (!visited[point])
                    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    var result = BFSSetup(startPointInt, endPointInt);
